...
public class ModConfig {
    ...
    // ---- Owner & ProjectileEntity Tracking ----------------------------------------
    ...
    public static dev.isxander.yacl3.api.YetAnotherConfigLib generateGui() {
        ...
        for (dev.isxander.yacl3.api.ConfigCategory category : baseGui.categories()) {
            ...
            for (dev.isxander.yacl3.api.OptionGroup group : category.groups()) {
                ...
                String groupKey = "";
                if (group.name().getContent() instanceof net.minecraft.text.TranslatableTextContent tc) {
                    groupKey = tc.getKey();
                } else {
                ...
                for (dev.isxander.yacl3.api.Option<?> opt : group.options()) {
                    if (opt != null && opt.name() != null && opt.name().getContent() instanceof net.minecraft.text.TranslatableTextContent tc) {
            ...
            if (serverOption != null && category.name().getContent() instanceof net.minecraft.text.TranslatableTextContent translatable) {
