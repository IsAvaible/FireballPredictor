...
public class PredictionData {
    ...
    public PredictionData(List<Vec3d> path, List<Vec3d> velocities, HitResult hitResult, HitResult damageHitResult, List<BlockPos> brokenBlocks, Vec3d initialVelocity, PredictionRenderData renderData, int predictionAge) {
        this.path = path;
