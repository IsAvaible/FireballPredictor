...
final class RenderUtils {
    ...
    static final Identifier BLAZE_POWDER_ICON =
            Identifier.ofVanilla("textures/item/blaze_powder.png");
    static final Identifier GHAST_TEAR_ICON =
            Identifier.ofVanilla("textures/item/ghast_tear.png");
    ...
    static final Identifier DRAGON_FIREBALL_TEXTURE =
            Identifier.ofVanilla("textures/entity/enderdragon/dragon_fireball.png");
    ...
    static final Identifier DEFAULT_SKIN_LEGACY =
            Identifier.ofVanilla("textures/entity/steve.png");

    static final Identifier DISPENSER_FRONT =
            Identifier.ofVanilla("textures/block/dispenser_front.png");
    static final Identifier COMMAND_BLOCK_FRONT =
            Identifier.ofVanilla("textures/block/command_block_front.png");
    ...
    private static final IconTexture NO_ICON =
            IconTexture.sprite(Identifier.ofVanilla("textures/misc/unknown_pack.png"));
    ...
    private static boolean drawKnownVanillaIconTexture(Painter p, Item item, int x, int y, int size) {
        ...
        try {
            p.graphics().drawTexture(RenderPipelines.GUI_TEXTURED,
                    icon.texture(), x, y,
                    icon.u(), icon.v(),
                    size, size,
                    icon.srcW(), icon.srcH(),
    ...
    private static List<IconTexture> candidatesFor(Item item) {
        ...
        Identifier id;
        try {
            id = Registries.ITEM.getKey(item).map(RegistryKey::getValue).orElse(null);
        } catch (RuntimeException | LinkageError ignored) {
            return List.of();
        }
        if (id == null) {
