...
/**
 * ProjectileEntity category model for HUD impact warning badge icons and progress bar themes.
 */
public enum WarningProjectileType {
    ...
    public static WarningProjectileType fromProjectile(ExplosiveProjectileEntity projectile) {
