 ...
 *
 * <p>Assigns {@link PredictionPipelines#PIPELINE} to Iris {@code ShaderKey.LIGHTNING} via internal reflection.
 ...
 *
 * <p>All Iris classes are accessed reflectively so the mod compiles and runs without Iris installed.
 */
public final class IrisCompat {
    ...
    public static void init() {
        ...
        if (assignInternal(PredictionPipelines.PIPELINE, PREFERRED_SHADER_KEY)) {
            return;
        }
        assignViaPublicApi(PredictionPipelines.PIPELINE);
    }
    ...
    private static final class Holder {
        @SuppressWarnings({"unchecked", "rawtypes"})
        private static void assignBasic(RenderPipeline pipeline) throws Throwable {
            Class<?> apiClass = Class.forName("net.irisshaders.iris.api.v0.IrisApi");
            Object api = apiClass.getMethod("getInstance").invoke(null);
            Class<?> programClass = Class.forName("net.irisshaders.iris.api.v0.IrisProgram");
            Object basic = Enum.valueOf((Class<Enum>) programClass, "BASIC");
