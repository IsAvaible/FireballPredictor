...
A client-side Fabric mod for Minecraft 1.21.11 that visualizes the trajectory and impact of fireballs, wither skulls, and wind charges in real-time.
...
| **Java** | `Java 21` | Gradle toolchain target |
